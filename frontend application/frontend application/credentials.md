...
**⚠️ IMPORTANT: These are test credentials for demonstration purposes only. Do not use in production environments.**
...
- **threat_events**: Security event records
- **network_traffic**: Network activity logs  
- **response_actions**: Automated response logs
- **system_metrics**: Performance metrics
- **model_performance**: AI model statistics
...
Supported threat types: `ddos`, `malware`, `bruteforce`, `botnet`, `exfiltration`, `zeroday`
Supported severities: `low`, `medium`, `high`, `critical`
Supported statuses: `detected`, `investigating`, `mitigated`, `false_positive`
